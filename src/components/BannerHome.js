            ...
            >
              ...
              <div className="container mx-auto ">
                <div className=" absolute  max-w-md px-4 bottom-14   ">
                  ...
                  <button className="bg-white px-4 py-2 text-black font-bold rounded mt-4 hover:bg-gradient-to-l from-red-700 to-orange-500 hover:shadow-md transition-all hover:scale-105">
                    Play Now
                  </button>
                </div>
              </div>
